...
namespace MMTB.View
{
    public partial class Form_M0013_LK : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public Form_M0013_LK()
        {
            InitializeComponent();
        }

        public Form_M0013_LK(System_DAL systemDAL)
        {
            InitializeComponent();
        ...
        private void GetInfo_GridView()
        {
            try
            {
                _tempTable = M0013_DAO.GetInfo_M0013_NoPrice("1");
        ...
        //Load form 
        private void Form_M0013_LK_Load(object sender, EventArgs e)
        {
