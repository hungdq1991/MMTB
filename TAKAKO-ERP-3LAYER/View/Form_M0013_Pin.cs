...
namespace MMTB.View
{
    public partial class Form_M0013_Pin : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        public Form_M0013_Pin()
        {
            InitializeComponent();
        }

        public Form_M0013_Pin(System_DAL systemDAL)
        {
            InitializeComponent();
        ...
        private void GetInfo_GridView()
        {
            try
            {
                _tempTable = M0013_DAO.GetInfo_M0013_NoPrice("4");
        ...
        //Load form 
        private void Form_M0013_Pin_Load(object sender, EventArgs e)
        {
        ...
        private void BbiLoad_ItemClick(object sender, ItemClickEventArgs e)
        {
            try
            {
                _tempTable = M0013_DAO.GetInfo_M0013("4");
                if (_tempTable.Rows.Count > 0)
                {
