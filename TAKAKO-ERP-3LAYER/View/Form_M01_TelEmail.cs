...
namespace MMTB.View
{
    public partial class Form_M01_TelEmail : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        ...
        #endregion
        //Khởi tạo Form_M01_TelEmail
        public Form_M01_TelEmail()
        {
            InitializeComponent();
        }
        //Khởi tạo form,  kèm systemDAL
        public Form_M01_TelEmail(System_DAL systemDAL)
        {
            InitializeComponent();
            //
        ...
        //Load dữ liệu của Form_M01_TelEmail
        private void GetInfo_gridView1()
        {
            try
            {
                _tempTable = M01_DAO.GetInfo_M01_TelEmail();
        ...
        //Load form
        private void Form_M01_TelEmail_Load(object sender, EventArgs e)
        {
            //
            M01_DAO = new M01_DAO();
        ...
        private void Cbx_Status_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cbx_Status.SelectedIndex == 2)
            {
                ...
                gridControl.DataSource = _DetailTable;
                Set_Enable_Control(true);
                gridCol_HandPhone.OptionsColumn.AllowEdit = false;
        ...
        /// Form Closing
        /// </summary>
        private void Form_M01_TelEmail_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        #region event gridView1 - Sự kiện liên quan gridView1
        /// <summary>
        /// Khởi tạo thêm dòng mới gridView1
        /// </summary>
        ...
        //Dữ liệu trên Form_M01_TelEmail
        private void Setting_Init_Control()
        {
            //Pass username
            bsiUser.Caption = _systemDAL.userName.ToUpper();
            //Định nghĩa datatable gán cho gridView1
            Define_DetailTable();
            //
        ...
        private void Set_Enable_Control(Boolean IsEnable)
        {
            ...
            gridCol_HandPhone.OptionsColumn.AllowEdit = IsEnable;
            ...
            gridCol_InActiveIntPhone.OptionsColumn.AllowEdit = IsEnable;
        ...
        private void Define_DetailTable()
        {
            ...
            _DetailTable.Columns.Add("Phone", typeof(string));
            _DetailTable.Columns.Add("IntPhone", typeof(string));
            _DetailTable.Columns.Add("HandPhone", typeof(string));
            ...
            _DetailTable.Columns.Add("InActiveIntPhone", typeof(int));
            _DetailTable.Columns.Add("InActiveEmail", typeof(int));
            _DetailTable.Columns.Add("InputUser", typeof(string));
            _DetailTable.Columns.Add("InActiveIntPhoneUser", typeof(string));
            _DetailTable.Columns.Add("InActiveEmailUser", typeof(string));
