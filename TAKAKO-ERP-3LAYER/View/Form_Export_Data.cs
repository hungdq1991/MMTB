    ...
    public partial class Form_Export_Data : Form
    {
        ...
        private void btnExport_Test_Click(object sender, EventArgs e)
        {
            ...
            if (theDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                //        ExcelWorksheet _invoiceDetail = _excelPackage.Workbook.Worksheets[1];
                ...
                //        _tableOutput.Columns.Add("D_COLUMN");
                ...
                //        _tableOutput.Columns.Add("H_COLUMN");
                ...
                //        //write the file to the disk
                //        File.WriteAllBytes(_saveFileDialog.FileName, bin);
                //        MessageBox.Show("Xuất thành công!", "Hoàn Thành", MessageBoxButtons.OK, MessageBoxIcon.Information);
                //    }
                //}
            }
        }
