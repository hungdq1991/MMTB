...
namespace MMTB.View
{
    public partial class Form_M0006_Detail : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        #region Biến
        ...
        public Form_M0006_Detail(Boolean _isNewValue, System_DAL systemDAL)
        {
            InitializeComponent();
        ...
        public Form_M0006_Detail(DataRow _mainDataRow, System_DAL systemDAL)
        {
            //
            InitializeComponent();
            //
        ...
        private void Form_M0006_Detail_Load(object sender, EventArgs e)
        {
            //
        ...
        private void Initialization_Control()
        {
            ...
            else
            {
                ...
                ACCCode = Convert.ToString(dataRow[1]);
                NameEN = Convert.ToString(dataRow[2]);
                NameVN = Convert.ToString(dataRow[3]);
                NameJP = Convert.ToString(dataRow[4]);
                ...
                Level = Convert.ToInt32(dataRow[9]);
                SizeL = Convert.ToInt32(dataRow[10]);
                SizeW = Convert.ToInt32(dataRow[11]);
                SizeH = Convert.ToInt32(dataRow[12]);
                Chuck3Jaw = Convert.ToString(dataRow[13]);
                Collet1 = Convert.ToString(dataRow[14]);
                Collet2 = Convert.ToString(dataRow[15]);
                Collet3 = Convert.ToString(dataRow[16]);
                Voltage = Convert.ToString(dataRow[17]);
                OperatingSys = Convert.ToString(dataRow[18]);
                Wattage_KVA = Convert.ToDecimal(dataRow[19]);
                inActive = Convert.ToBoolean(dataRow[21]);
                //Load dữ liệu cho group control: Máy tiện
                string tempCode = Code;
                DataTable tempTable = new DataTable();
                tempTable = M0006_MayTien_DAO.GetInfo_Code(tempCode);
                if (tempTable.Rows.Count > 0)
                {
                    foreach (DataRow row in tempTable.Rows)
                    {
                        Turret_TipQty = Convert.ToInt32(row.Field<int>("Turret_TipQty"));
                        Horizontal_TipQty = Convert.ToInt32(row.Field<int>("Horizontal_TipQty"));
                        Tailstock = Convert.ToBoolean(row.Field<bool>("Tailstock"));
                        AxisC = Convert.ToBoolean(row.Field<bool>("AxisC"));
                        inActive_T = Convert.ToBoolean(row.Field<bool>("InActive"));
                    }
                }
                else
                {
                ...
                if (IsNewValue)
                {
                        ...
                        , MessageBoxDefaultButton.Button1) == System.Windows.Forms.DialogResult.Yes))
                    {
                        if (CheckError() == true)
                        {
                            ...
                            {
                                if (M0006_MayTien_DAO.Insert(curr_Code
                                                            ,curr_ACCCode
                                                            ,curr_NameEN
                                                            ,curr_NameVN
                                                            ,curr_NameJP
                            ...
                            {
                                if (M0006_MayPhay_DAO.Insert(curr_Code
                                                            ,curr_ACCCode
                                                            ,curr_NameEN
                                                            ,curr_NameVN
                                                            ,curr_NameJP
        ...
        public Boolean CheckError_MMTB()
        {
            ...
            _check = M0006_DAO.GetInfo_M0006_Check(sLook_Code.Text.Trim()
        ...
        public Boolean CheckError_MMTB_P()
        {
            ...
            _checkPhay = M0006_MayPhay_DAO.GetInfo_M0006_Check(sLook_Code.Text.Trim()
